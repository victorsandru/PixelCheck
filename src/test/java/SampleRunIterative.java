...
public class SampleRunIterative {
	...
	public static void main(String[] args){
		...
		/*Creates a test image, and runs the blob iterative algorithm. Modify the start object to change the parameters to search for blobs. */
